    ...
    PersistObjectTemplate.getFromPersistWithKnexQuery = function (requests, template, queryOrChains, cascade, skip, limit, isTransient, idMap, options, establishedObject, isRefresh, logger, enableChangeTracking, projection) {
        ...
        function getTemplatesFromPOJOS(pojos) {
            ...
            pojos.forEach(function (pojo, ix) {
                ...
                promises.push(PersistObjectTemplate.getTemplateFromKnexPOJO(pojo, template, requests, idMap, cascade, isTransient, null, establishedObject, null, this.dealias(template.__table__) + '___', joins, isRefresh, logger, enableChangeTracking, projection)
                    .then(function (obj) {
        ...
        function (pojo, template, requests, idMap, cascade, isTransient, defineProperty, establishedObj, specificProperties, prefix, joins, isRefresh, logger, enableChangeTracking, projection) {
                ...
                function generateQueryRequest() {
                    var fetcher = join ?
                        (pojo[join.alias + '____id'] ?
                            this.getTemplateFromKnexPOJO(pojo, closureType, requests, idMap, closureCascade, isTransient, closureDefineProperty, obj[closureProp], null, join.alias + '___', null, isRefresh, logger, enableChangeTracking, projection)
                            : Promise.resolve(true)) :
                        this.getFromPersistWithKnexQuery(requests, closureType, query, closureCascade, null, null, isTransient, idMap, {}, obj[closureProp], isRefresh, logger, enableChangeTracking, projection);
                    this.withoutChangeTracking(function () {
            ...
            function queueChildrenLoadRequest(obj, prop, schema, defineProperty, projection) {
                ...
                requests.push(function () {
                    return this.getFromPersistWithKnexQuery(requests, closureOf, query, closureCascade, null, limit, isTransient, idMap, options, obj[closureProp], isRefresh, logger, null, projection)
                        .then(function (objs) {
                        this.withoutChangeTracking(function () {
                            if (foreignFilterKey) {
